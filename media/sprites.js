...
(function (root) {
  ...
  // Bichos dos biomas (liberados ao restaurar cada bioma no jogo)
  Object.assign(PETS, {
    tamandua: {
      name: 'Tamanduá-bandeira',
      speed: 0.025,
      legRows: 2,
      pal: { b: '#8d7b68', d: '#4a3b2f', k: '#1b1b1b', w: '#e8e0d0', e: '#111111' },
      A: [
        '................',
        '................',
        'd...............',
      ...
      B: ['...k.k..k.k.....', '...k.k..k.k.....'],
      sounds: ['*fareja formigas*', 'Snif snif.', 'Cerrado de pé!'],
    },
    tatu: {
      name: 'Tatu-bola',
      speed: 0.022,
      legRows: 2,
      pal: { s: '#a58a6a', S: '#7a6248', h: '#c9a98a', e: '#1b1b1b', n: '#5a4030' },
      A: [
        '................',
        '................',
        '................',
      ...
      B: ['....h.h.h.h.....', '................'],
      sounds: ['*vira bolinha*', 'Caatinga resiste.', 'Rolando por aí.'],
    },
    arara: {
      name: 'Arara-azul',
      speed: 0.035,
      legRows: 2,
      pal: { b: '#1e6fe5', B: '#1450a8', y: '#ffd84d', w: '#ffffff', e: '#111111', k: '#333333' },
      A: [
        '................',
        '..........bbb...',
        '.........bbyek..',
      ...
      B: ['.......k...k....', '................'],
      sounds: ['Rrraaa!', 'Pantanal em festa!', '*abre as asas*'],
    },
    mico: {
      name: 'Mico-leão-dourado',
      speed: 0.045,
      legRows: 2,
      pal: { o: '#ff9f1c', O: '#e07b00', f: '#5a3a1a', e: '#fff4e0' },
      A: [
        '...........OOO..',
        '..........OOOOO.',
        '..........OffeO.',
      ...
      B: ['.......o.o.o.o..', '.......f.f.f.f..'],
      sounds: ['Iiih iiih!', 'A Mata Atlântica voltou!', '*pula de galho em galho*'],
    },
    onca: {
      name: 'Onça-pintada',
      speed: 0.05,
      legRows: 2,
      pal: { y: '#f2a93b', k: '#2b2b2b', w: '#fff4e0', e: '#1b1b1b', p: '#ff8fa3' },
      A: [
        '................',
        '...........y.y..',
        '..........yyyyy.',
      ...
      B: ['...y.y...y.y....', '...k.k...k.k....'],
      sounds: ['Grrr.', 'A floresta é minha casa.', '*ronrona alto*'],
    },
  });
